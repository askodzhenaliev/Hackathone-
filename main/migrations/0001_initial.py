    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budged', models.PositiveIntegerField(default=0, help_text='Указывать сумму в Долларах США', verbose_name='Бюджет фильма')),
                ('url', models.SlugField(max_length=150, unique=True)),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='main.Actor', verbose_name='Режжисер')),
